...
//		showKnapp();
	...
	//initaliserar root layout ("Bakgrunnen"), har moglegheit til å legge til ein rekke element her om ynskjeleg
...
//			dialogStage.initModality(Modality.WINDOW_MODAL); //Gjer at du ikkje kan interaktere med det førre vinduet før du er ferdig med pop-upen
	...
	public void showLogin(){
		try{
			  FXMLLoader loader = new FXMLLoader();
	            loader.setLocation(MainApp.class.getResource("LoginTest.fxml"));
